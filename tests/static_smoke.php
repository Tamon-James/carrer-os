...
$required=[
  ...
  'database/migrations/003_operations_v2.sql',
  'database/verify_operations_v2.php',
...
foreach([
  ...
  'database/migrations/003_operations_v2.sql'=>'note_groups',
  'public/notes.php'=>"render('notes'",
  'public/tutorial.php'=>"render('tutorial'",
  'public/companyFile.php'=>"tutorial=flow",
  'public/company.php'=>"tutorial=note",
  'public/campe.php'=>"complete_tutorial",
  'public/lib/app.php'=>'delete_tutorial_data',
  'views/company.php'=>'data-step-type',
  'public/company.php'=>"isset(\$_POST['interview_visible'])",
